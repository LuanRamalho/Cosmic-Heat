...
def save_high_score(file_path, high_score):
    with open(file_path, 'w') as file:
        json.dump({"high_score": hi_score}, file)

# Caminho do arquivo JSON para o High Score
HIGH_SCORE_FILE = "high_score.json"

score = 0
hi_score = load_high_score(HIGH_SCORE_FILE)
player = Player()
player_life = 200
bullet_counter = 200
...
while running:
    ...
    if score > hi_score:
        hi_score = score
        save_high_score(HIGH_SCORE_FILE, hi_score)  # Salvar novo High Score
